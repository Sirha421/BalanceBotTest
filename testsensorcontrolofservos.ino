...
//get the array from processing and convert it to a float value. this converts the float values into bytes and then sends those bytes to the arduino the nconverts it back to floats when reciveing the data from teh arduino 
union {
